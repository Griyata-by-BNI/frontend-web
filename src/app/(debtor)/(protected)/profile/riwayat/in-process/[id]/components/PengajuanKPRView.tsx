...
export const PengajuanKPRView = ({
  ...
  const dataNasabah = [
    { label: "Nama Lengkap", value: debtor_information.full_name },
    {
      ...
      value: debtor_information.mother_maiden_name,
    },
    {
      label: "Jenis Kelamin",
      value: debtor_information.gender === "L" ? "Laki-laki" : "Perempuan",
    },
    {
      label: "Tanggal Lahir",
      value: new Date(debtor_information.birth_date).toLocaleDateString(
        "id-ID"
      ),
    },
    { label: "Tempat Lahir", value: debtor_information.place_of_birth },
    {
      ...
      value: debtor_information.marital_status?.replace("_", " "),
    },
    {
      label: "Status Tempat Tinggal",
      value: debtor_information.residence_status,
    },
  ...
  const dataPasangan = spouse_information
    ? [
        ...
        {
          label: "Jenis Kelamin",
          value: spouse_information.gender === "L" ? "Laki-laki" : "Perempuan",
        },
        {
          label: "Tanggal Lahir",
          value: new Date(spouse_information.birth_date).toLocaleDateString(
            "id-ID"
          ),
        },
  ...
  const dataKontak = [
    ...
    {
      label: "Telepon Rumah",
      value: emergency_contact.homePhoneNumber.toString(),
    },
    {
      label: "Nomor HP",
      value: emergency_contact.mobilePhoneNumber.toString(),
    },
  ...
  const dataPekerjaan = [
    ...
    {
      label: "Lama Bekerja",
      value: `${employee_information.length_of_work_years} Tahun`,
    },
    {
      label: "Gaji Pokok",
      value: `Rp ${employee_information.basic_salary.toLocaleString("id-ID")}`,
    },
    {
      label: "Pendapatan Lain",
      value: `Rp ${employee_information.other_income.toLocaleString("id-ID")}`,
    },
    {
      label: "Total Pendapatan",
      value: `Rp ${employee_information.total_income.toLocaleString("id-ID")}`,
    },
    {
      label: "Total Pengeluaran",
      value: `Rp ${employee_information.total_expenses.toLocaleString(
        "id-ID"
      )}`,
    },
  ];
  ...
  const dataProperti = propertyData
    ? [
        ...
        {
          label: "Harga",
          value: `Rp ${Number(propertyData.price).toLocaleString("id-ID")}`,
        },
        { label: "Lokasi", value: propertyData.location },
        {
          label: "Kamar Tidur",
          value: propertyData.jumlahKamarTidur.toString(),
        },
        {
          label: "Kamar Mandi",
          value: propertyData.jumlahKamarMandi.toString(),
        },
        ...
        {
          label: "Kolam Renang",
          value: propertyData.kolamRenang ? "Ya" : "Tidak",
        },
      ]
    : [];
  ...
  const dataPinjaman = [
    {
      ...
      value: `Rp ${Number(loan_information.loan_value).toLocaleString(
        "id-ID"
      )}`,
    },
    {
      label: "Jangka Waktu",
      value: `${loan_information.monthly_period} bulan`,
    },
  ];
