        ...
        <div className="bg-gray-50 rounded-2xl overflow-hidden shadow-lg transition-transform duration-300 ease-in-out hover:-translate-y-1 hover:shadow-xl flex flex-col">
          <div>
            <img
              ...
              className="w-full h-40 sm:h-56 lg:h-64 object-cover block"
            />
          </div>

          <div className="p-4 sm:p-6 text-center flex flex-col flex-grow">
            <h3 className="text-xl sm:text-2xl font-bold text-[#007A70] m-0 mb-2">
              Cek Kemampuan KPR-mu
            </h3>
            <p className="text-gray-600 text-sm m-0 mb-4 sm:mb-6 flex-grow">
            ...
            <Link
              ...
              className="block w-full bg-[#27C5B8] text-white py-2.5 sm:py-3 px-5 sm:px-6 rounded-lg no-underline font-bold text-sm sm:text-base transition-all duration-200 ease-in-out hover:bg-[#21b3a6] hover:scale-105 mt-auto"
            >
              Cek Sekarang!
            </Link>
          </div>
